<div id="reviews" class="reviews tab-pane fade in clearfix {{ request()->has('reviews') || Rviw::form_has_error($errors) ? 'active' : '' }}">
    <div class="row">
        @include('storefront::public.products.partials.product.reviews.ratings_overview')
