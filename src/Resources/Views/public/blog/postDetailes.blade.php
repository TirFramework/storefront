                ...
                <div class="mainside col-md-9">
                    ...
                    <div class="main-article">
                        ...
                        <div class="article-pic">
                            <img src="{{ $post->images['main'] }}" alt="{{ $post->title}}" class="mw-100">
                        ...
                        <div class="share-and-comment">
                            ...
                            <div class="share-it">
                                <ul>
                                    <li class=""> <a href="https://www.facebook.com/sharer.php?u={{ config('app.url') }}/{{$post->slug}}">
                                ...
                                <li class=""> <a href="tg://msg_url?url={{ config('app.url') }}/{{$post->slug}}">
                                ...
                                <li class=""> <a href="https://twitter.com/intent/tweet?url={{ config('app.url') }}/{{$post->slug}}">
                                ...
                                <li class=""> <a href="whatsapp://send?text={{ config('app.url') }}/{{$post->slug}}">
